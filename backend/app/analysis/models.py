...
class StaticFinding(BaseModel):
    ...
    category: str = Field(default="UNKNOWN", description="Engineering category of the finding")
    confidence: int = Field(default=100, description="Confidence score 0-100 (defaults to 100 for static tools)")
