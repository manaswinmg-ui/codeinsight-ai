...
@pytest.mark.asyncio
async def test_query_repository_endpoint(client: AsyncClient, db_session: AsyncSession) -> None:
    ...
    with patch("app.ai.router.AIRouter.query_repository", new_callable=AsyncMock) as mock_query:
...
@pytest.mark.asyncio
async def test_query_repository_endpoint_not_found(client: AsyncClient, db_session: AsyncSession) -> None:
