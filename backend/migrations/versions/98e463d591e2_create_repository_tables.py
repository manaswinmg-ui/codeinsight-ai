...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "PROCESSING", "COMPLETED", "FAILED", name="reviewstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_repository_embeddings_id"),
        "repository_embeddings",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_repository_embeddings_id"), table_name="repository_embeddings"
    )
