...
export const RepositoryProgress: React.FC<RepositoryProgressProps> = ({
  repoName,
  onBackToHistory,
}) => {
  return (
    ...
    >
      ...
      <h2
        style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '12px' }}
      >
        Analyzing {repoName}
      </h2>
      ...
      >
        The Hybrid Analysis Engine is reviewing your codebase. Multiple files
        are being evaluated in parallel. Larger codebases may take a minute.
      </p>
