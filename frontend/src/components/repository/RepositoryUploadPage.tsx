...
export const RepositoryUploadPage: React.FC<RepositoryUploadPageProps> = ({ onUploadSuccess }) => {
        ...
        <div style={{ maxWidth: '680px', margin: '40px auto', padding: '0 20px' }}>
            <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: '1.5' }}>
                    Upload a ZIP archive of your project directory to run automated multi-file reviews and evaluate codebase quality.
                </p>
            </div>
            ...
            >
                ...
                {uploading ? (
                    <div>
                        ...
                        />
                        <p style={{ fontWeight: 600, fontSize: '1.1rem' }}>Uploading and scanning archive...</p>
                    ...
                    <div>
                        <p style={{ fontSize: '1.15rem', fontWeight: 600, marginBottom: '8px' }}>
                            Drag and drop your ZIP here, or <span style={{ color: 'var(--accent-color)' }}>browse files</span>
                        </p>
            ...
            >
                ...
                >
                    <li>Excludes metadata and build folders: <code>node_modules</code>, <code>.git</code>, <code>dist</code>, <code>venv</code>, etc.</li>
                    <li>Skips compiled binaries and unrecognized text types.</li>
                    <li>Supported file extensions: <code>.py</code>, <code>.js</code>, <code>.ts</code>, <code>.tsx</code>, <code>.go</code>, <code>.java</code>, <code>.cpp</code>, <code>.cs</code>.</li>
                    <li>Limits: Max 1,000 total files, 500 source files, and 2 MB per file.</li>
                </ul>
            </div>
